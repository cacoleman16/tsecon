...
**123 functions** organized as a task-oriented facade over **41 Rust crates**,
...
The 123 functions span the applied workflow end to end:
...
suite (517 tests collected) whose fixtures are gated against `statsmodels`,
