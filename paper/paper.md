...
**116 functions** organized as a task-oriented facade over **41 Rust crates**,
...
The 116 functions span the applied workflow end to end:
...
suite (483 tests collected) whose fixtures are gated against `statsmodels`,
