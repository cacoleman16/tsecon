...
**113 functions** organized as a task-oriented facade over **40 Rust crates**,
...
The 113 functions span the applied workflow end to end:
...
suite (471 tests collected) whose fixtures are gated against `statsmodels`,
