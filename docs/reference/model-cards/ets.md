...
| `n_sim`, `seed` | `None` = 5000, `None` = 0 | Simulated intervals for the non-class-1 models; refused for a class-1 model, where the interval is exact and nothing is simulated |
