...
1010 Rust + 517 Python tests — all green and golden-fixture-gated.** The whole
...
- **[Model cards & API reference](docs/reference/README.md)** — the
  ...
  estimator, plus the full 123-function reference.
...
123 functions callable from Python today: diagnostics, unit-root and
