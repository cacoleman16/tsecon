...
1010 Rust + 496 Python tests — all green and golden-fixture-gated.** The whole
...
- **[Model cards & API reference](docs/reference/README.md)** — the
  ...
  estimator, plus the full 122-function reference.
...
122 functions callable from Python today: diagnostics, unit-root and
