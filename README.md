...
812 Rust + 454 Python tests — all green and golden-fixture-gated.** The whole
...
- **[Model cards & API reference](docs/reference/README.md)** — the
  ...
  estimator, plus the full 105-function reference.
...
105 functions callable from Python today: diagnostics, unit-root and
