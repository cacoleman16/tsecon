...
812 Rust + 468 Python tests — all green and golden-fixture-gated.** The whole
...
- **[Model cards & API reference](docs/reference/README.md)** — the
  ...
  estimator, plus the full 106-function reference.
...
106 functions callable from Python today: diagnostics, unit-root and
