...
812 Rust + 380 Python tests — all green and golden-fixture-gated.** The whole
...
- **[Model cards & API reference](docs/reference/README.md)** — the
  ...
  estimator, plus the full 104-function reference.
...
104 functions callable from Python today: diagnostics, unit-root and
