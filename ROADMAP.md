...
**In active development (Phases 3 & 4, running concurrently):** cointegration/VECM + Johansen (Module 04), Markov-switching AR (Module 02), MIDAS mixed-frequency regressions (Module 08), CCC/DCC multivariate GARCH (Module 03), and spectral analysis (Module 01) — each golden-gated against statsmodels, scipy, or documented references, plus new gallery visuals for the structural and shrinkage methods.
