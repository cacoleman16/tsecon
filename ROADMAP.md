...
had a runnable golden has shipped. The in-flight 0.6.0 candidates (DCC variants and
correlation forecasts, Beveridge-Nelson/Kamber-Morley-Wong trend-cycle, conformal
forecast intervals, the interval-coverage expansion, and the user-reported
short-sample/convention repairs) are preserved on `claude/wip-0.5.0-*` branches,
unverified and ungated.
